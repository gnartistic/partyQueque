...
const ThemeToggle: React.FC = () => {
  const [themeName, setThemeName] = useAtom<string>(themeAtom);
  const themes: string[] = ["black", "red", "blue", "orange", "green", "yellow", "pink", "purple", "white"];
  ...
  const toggleTheme = () => {
    ...
    setTimeout(() => {
      ...
      setThemeName(themes[nextThemeIndex] ?? "white");
