...
import { Flex, Spinner, useDisclosure, Icon } from "@chakra-ui/react";
import { themeAtom } from "@/atoms/theme";
import { queueAtom, ProcessedTrack } from "@/atoms/queueAtom";
...
const QueueButton: React.FC<QueueButtonProps> = ({
    ...
    const addedSongsCount = Number(localStorage.getItem("addedSongsCount") || 0);
    ...
    const addToQueue = async () => {
        ...
        try {
            ...
            const newCount = addedSongsCount + 1;
            localStorage.setItem("addedSongsCount", newCount.toString());
